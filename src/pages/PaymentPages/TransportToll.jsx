...
const TransportToll = () => {
  ...
  useEffect(() => {
    if (selectedBiller === "PAYGATE NO REFERENCE") {
      setinitialValues({
        ProductId: "",
        Amount: "",
        VendorParameterValue: "",
    ...
    } else if (selectedBiller === "PAYGATE REFERENCE") {
      setinitialValues({
        ProductId: "",
        VendorParameterValue: "",
        EmailAddress: "",
                ...
                return (
                  <div className="flex-[1] py-[0]">
                    <h3 className="font-roboto text-[1.5rem] text-[#464255]">
                      Transportation & Toll Services
                    </h3>
                    <p className="text-[#464255]">
                      To pay transportation & toll services, provide the details
                      below
                    </p>
                    ...
                    <Form className="mt-10">
                      <ComboSelect
                        ...
                        label="Transport & Toll Products"
                        placeholder="Select product"
                        name="ProductId"
                      />
                      {selectedBiller === "PAYGATE REFERENCE" || (
                        <Input
                          error={error}
                          showError={error}
                          label="Amount"
                      ...
                      {extraInputField}
                      {selectedBiller === "PAYGATE NO REFERENCE" || (
                        <Input
                          error={error}
                          showError={error}
                          label={
